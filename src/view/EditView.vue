...
const handleSubmit = async () => {
    ...
    try {
        const response = await api.put(`/${jobId}`, newJob);
        ...
        <div class="container max-w-2xl py-24 m-auto">
            <div class="px-6 py-8 m-4 mb-4 bg-white border rounded-md shadow-md md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div>
                        <button
                            class="w-full px-4 py-2 font-bold text-white bg-green-500 rounded-md hover:bg-green-600 focus:outline-none focus:shadow-outline"
                            type="submit">
                            Edit Job
                        </button>
                    </div>
